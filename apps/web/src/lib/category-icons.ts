...
export const CATEGORY_VISUALS: Record<string, { glyph: string; accent: string; fill: string; label: string }> = {
  ...
  restroom_male: { glyph: CATEGORY_GLYPH.restroom_male, accent: "#2563eb", fill: "#eff6ff", label: "Male restroom" },
  restroom_female: { glyph: CATEGORY_GLYPH.restroom_female, accent: "#db2777", fill: "#fdf2f8", label: "Female restroom" },
